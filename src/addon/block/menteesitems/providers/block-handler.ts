 ...
 */
@Injectable()
export class AddonBlockMenteesItemsHandler extends CoreBlockBaseHandler {
    name = 'AddonBlockMenteesItems';
    blockName = 'mentees';
    ...
    getDisplayData(injector: Injector, block: any, contextLevel: string, instanceId: number)
        ...
        return {
            title: 'addon.block_menteesitems.pluginname',
            class: 'addon-block-mentees-items',
