...
export class CoreCoursesEnrolPushClickHandler implements CorePushNotificationsClickHandler {
    ...
    handles(notification: any): boolean | Promise<boolean> {
        return (this.utils.isTrueOrOne(notification.notif) || this.utils.isTrueOrOne(notification.notification)) && (notification.moodlecomponent.indexOf('enrol_') || notification.component.indexOf('enrol_')) === 0 &&
